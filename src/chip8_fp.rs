...
impl Chip8
{
	...
	let mut chip = Chip8
	{
	    ...
	    t_8000:
	    {[
		Chip8::i_8XY0, Chip8::i_8XY1, Chip8::i_8XY2, Chip8::i_8XY3,
		Chip8::i_8XY4, Chip8::i_8XY5, Chip8::i_8XY6, Chip8::i_8XY7,
		Chip8::i_NULL, Chip8::i_NULL, Chip8::i_NULL, Chip8::i_NULL,
	    ...
	    t_E000:
	    {[
		Chip8::i_EX9E, Chip8::i_NULL, Chip8::i_NULL, Chip8::i_EXA1
	    ]},
    ...
    fn i_0000(&mut self, bit: &Bit) { self.t_0000[(self.opcode & 0x000F) as usize](self, bit); }
    fn i_8000(&mut self, bit: &Bit) { self.t_8000[(self.opcode & 0x000F) as usize](self, bit); }
    fn i_E000(&mut self, bit: &Bit) { self.t_E000[(self.opcode & 0x00FF) as usize - 158](self, bit); }
